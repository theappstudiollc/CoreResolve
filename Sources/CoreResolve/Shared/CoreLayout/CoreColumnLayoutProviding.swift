...
public extension CoreColumnLayoutProviding {
	...
	/// - Returns: A Disposable collection of constraints generated by the method
	@discardableResult func constrainColumn(_ column: Int, to columnLayoutProviding: CoreColumnLayoutProviding, with priority: LayoutPriority = .required) -> [NSLayoutConstraint] {
