...
open class CoreSplitViewController: UISplitViewController { }

#elseif DEBUG

/// Core split view controller, that enables CorePrintsSupporting capabilities in DEBUG mode
open class CoreSplitViewController: UISplitViewController, CorePrintsSupporting {
...
public typealias CoreSplitViewController = UISplitViewController
